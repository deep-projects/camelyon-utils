    ...
    if MODE == 'single':
        ...
        for i in range(7500):
            ...
            for j in range(len(f_t_train)):
                ...
                new_t_train[i*len(f_t_train)+j] = h5['img'][np.random.randint(0,h5['img'].shape[0])]
            ...
            for j in range(len(f_n_train)):
                ...
                new_n_train[i*len(f_n_train)+j] = h5['img'][np.random.randint(0,h5['img'].shape[0])]
            ...
            for j in range(len(f_t_valid)):
                ...
                new_t_val[i*len(f_t_valid)+j] = h5['img'][np.random.randint(0,h5['img'].shape[0])]
            ...
            for j in range(len(f_n_valid)):
                ...
                new_n_val[i*len(f_n_valid)+j] = h5['img'][np.random.randint(0,h5['img'].shape[0])]
