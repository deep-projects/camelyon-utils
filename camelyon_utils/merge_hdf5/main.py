        ...
        for i in range(7500):
            ...
            for j in range(len(f_t_train)):
                ...
                if h5['img'].shape[1] >= 1:
                    ...
                    new_t_train[i*len(f_t_train)+j] = merged_tumor_dset_train[-1]
            ...
            for j in range(len(f_n_train)):
                ...
                if h5['img'].shape[1] >= 1:
                    ...
                    new_n_train[i*len(f_n_train)+j] = merged_normal_dset_train[-1]
            ...
            for j in range(len(f_t_valid)):
                ...
                if h5['img'].shape[1] >= 1:
                    ...
                    new_t_val[i*len(f_t_valid)+j] = merged_tumor_dset_val[-1]
            ...
            for j in range(len(f_n_valid)):
                ...
                if h5['img'].shape[1] >= 1:
                    ...
                    new_n_val[i*len(f_n_valid)+j] = merged_normal_dset_val[-1]
